...
namespace BoyArge.CPM_Dashboards.OrderGraph
{
    partial class OrderGraphDashboard
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(OrderGraphDashboard));
            ...
            this.sqlDS = new DevExpress.DashboardCommon.DashboardSqlDataSource();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.sqlDS)).BeginInit();
            ...
            this.gridDashboardItem1.DataMember = "VWARGE_ORDER";
            this.gridDashboardItem1.DataSource = this.sqlDS;
            ...
            measure2.DataMember = "Sipariş Türü";
            ...
            this.pieDashboardItem1.DataMember = "VWARGE_ORDER";
            this.pieDashboardItem1.DataSource = this.sqlDS;
            ...
            this.chartDashboardItem1.DataMember = "VWARGE_ORDER";
            this.chartDashboardItem1.DataSource = this.sqlDS;
            ...
            measure5.DataMember = "Miktar";
            this.treemapDashboardItem1.DataItemRepository.Clear();
            this.treemapDashboardItem1.DataItemRepository.Add(dimension5, "DataItem1");
            this.treemapDashboardItem1.DataItemRepository.Add(measure5, "DataItem0");
            this.treemapDashboardItem1.DataMember = "VWARGE_ORDER";
            this.treemapDashboardItem1.DataSource = this.sqlDS;
            ...
            measure6.DataMember = "Miktar";
            measure7.DataMember = "Sevk Miktar";
            dimension6.DataMember = "Malzeme Adı";
            this.gaugeDashboardItem1.DataItemRepository.Clear();
            this.gaugeDashboardItem1.DataItemRepository.Add(measure6, "DataItem0");
            this.gaugeDashboardItem1.DataItemRepository.Add(measure7, "DataItem1");
            this.gaugeDashboardItem1.DataItemRepository.Add(dimension6, "DataItem2");
            this.gaugeDashboardItem1.DataMember = "VWARGE_ORDER";
            this.gaugeDashboardItem1.DataSource = this.sqlDS;
            gauge1.AddDataItem("ActualValue", measure7);
            ...
            this.dateFilterDashboardItem1.DataItemRepository.Add(dimension8, "DataItem1");
            this.dateFilterDashboardItem1.DataMember = "VWARGE_ORDER";
            this.dateFilterDashboardItem1.DataSource = this.sqlDS;
            this.dateFilterDashboardItem1.Dimension = dimension7;
            this.dateFilterDashboardItem1.HiddenDimensions.AddRange(new DevExpress.DashboardCommon.Dimension[] {
            dimension8});
            this.dateFilterDashboardItem1.Name = "Date Filter 1";
            this.dateFilterDashboardItem1.ShowCaption = true;
            // 
            // sqlDS
            // 
            this.sqlDS.ComponentName = "sqlDS";
            this.sqlDS.ConnectionName = "TEKSTIL_UYG_Connection";
            this.sqlDS.Name = "sqlDS";
            table1.MetaSerializable = "<Meta X=\"30\" Y=\"30\" Width=\"125\" Height=\"723\" />";
            table1.Name = "VWARGE_ORDER";
            allColumns1.Table = table1;
            selectQuery1.Columns.Add(allColumns1);
            selectQuery1.Name = "VWARGE_ORDER";
            ...
            dashboardLayoutItem1.Weight = 26.282051282051281D;
            dashboardLayoutItem2.DashboardItem = this.gridDashboardItem1;
            dashboardLayoutItem2.Weight = 73.717948717948715D;
            ...
            dashboardLayoutGroup3.Weight = 47.32472324723247D;
            dashboardLayoutItem3.DashboardItem = this.pieDashboardItem1;
            dashboardLayoutItem3.Weight = 48.161120840630474D;
            dashboardLayoutItem4.DashboardItem = this.gaugeDashboardItem1;
            dashboardLayoutItem4.Weight = 51.838879159369526D;
            ...
            dashboardLayoutGroup4.Weight = 52.67527675276753D;
            dashboardLayoutGroup2.ChildNodes.AddRange(new DevExpress.DashboardCommon.DashboardLayoutNode[] {
            dashboardLayoutGroup3,
            dashboardLayoutGroup4});
            dashboardLayoutGroup2.DashboardItem = null;
            dashboardLayoutGroup2.Weight = 53.333333333333336D;
            dashboardLayoutItem5.DashboardItem = this.treemapDashboardItem1;
            dashboardLayoutItem5.Weight = 47.32472324723247D;
            dashboardLayoutItem6.DashboardItem = this.chartDashboardItem1;
            dashboardLayoutItem6.Weight = 52.67527675276753D;
            ...
            dashboardLayoutGroup5.Weight = 46.666666666666664D;
            ...
            this.Title.Text = "Sipariş Grafikleri";
            ...
            ((System.ComponentModel.ISupportInitialize)(this.sqlDS)).EndInit();
        ...
        private DevExpress.DashboardCommon.DashboardSqlDataSource sqlDS;
