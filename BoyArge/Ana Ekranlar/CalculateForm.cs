            ...
            try
            {
                    ...
                    (byte)StockFeatureType.Status.Active, LoginForm.DataConnection))
                {
                    Format.LookUpEdit(lookStockFeatureTypeID,
                        new[] { "StockCode", "Name", "MachineGroup1", "MachineGroup2", "MachineGroup3", "MachineGroup4", "ColorType", "Touchness", "Feature" },
        ...
        private void PrintResult()
        {
            ...
            try
            {
                ...
                using (var dAnnualDer = ProductTreeFiche.GetTmpProductUnitCost(ProductTreeFicheId, LoginForm.DataConnection))
                {
                    ...
                    unitCost = Utility.ToFloat(dAnnualDer.Rows[0]["UnitCost"]);
                    bottleNeck = Utility.ToFloat(dAnnualDer.Rows[0]["DailyProductBottleNeck"]);
                }
                ...
                using (var fStockFeatureType = new StockFeatureTypeForm())
                {
                        ...
                        LoginForm.DataConnection))
                    {
                        Format.LookUpEdit(lookStockFeatureTypeID,
                            new[]
                            {
                                "StockCode", "Name", "MachineGroup1", "MachineGroup2", "MachineGroup3", "MachineGroup4","ColorType", "Touchness", "Feature"
                            }, "Name", "StockFeatureTypeID", dStockFeatureType);
                    }
                }
            }
