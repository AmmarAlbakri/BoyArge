...
namespace Business
{
    ...
    {
        public ProductionType(SqlConnection connection)
        {
        ...
        public const string TableName = "[dbo].[tblProductionType]";
        ...
        //        sql.AppendLine("    [ProductionTypeID],");
        //        sql.AppendLine("    [Code],");
        //        sql.AppendLine("    [Name],");
        //        sql.AppendLine("    [Status],");
        //        sql.AppendLine("    [RowGUID]");
        //        sql.AppendLine("FROM [dbo].[tblProductionType]");
        ...
        //        this.Table = Database.GetList(sql.ToString(), this.Connection, ProductionType.TableName);
        //    }
        //    else
        //    {
        //        this.Table = new DataTable(ProductionType.TableName);

        //        this.Table.Columns.Add("ProductionTypeID", typeof(long));
        ...
        public int Insert(ref object ProductionTypeID, object Name, object Code, object Status, ref object RowGUID)
        {
            if (Database.CheckConnection(Connection))
            {
                ...
                try
                {
                    cmd.CommandText = "[dbo].[spProductionTypeInsert]";
                    ...
                    cmd.Parameters["@ProductionTypeID"].Direction = ParameterDirection.InputOutput;
                    ...
                    ProductionTypeID = cmd.Parameters["@ProductionTypeID"].Value;
        ...
        public int Update(object ProductionTypeID, object Name, object Code, object Status, object RowGUID)
        {
            if (Database.CheckConnection(Connection))
            {
                var cmd = Connection.CreateCommand();
                ...
                try
                {
                    cmd.CommandText = "[dbo].[spProductionTypeUpdate]";
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int Delete(object ProductionTypeID)
        {
            if (Database.CheckConnection(Connection))
            {
                var cmd = Connection.CreateCommand();
                ...
                try
                {
                    cmd.CommandText = "[dbo].[spProductionTypeDelete]";
                    cmd.CommandType = CommandType.StoredProcedure;

                    cmd.Parameters.Add("@ProductionTypeID", SqlDbType.Int);
                    cmd.Parameters["@ProductionTypeID"].Value = ProductionTypeID;
                    cmd.Parameters["@ProductionTypeID"].Direction = ParameterDirection.Input;
        ...
        public static DataTable Select(long ProductionTypeID, int Status, SqlConnection connection)
        {
            if (Database.CheckConnection(connection))
            {
                var cmd = connection.CreateCommand();
                try
                {
                    cmd.CommandText = "[dbo].[spProductionTypeSelect]";
                    cmd.CommandType = CommandType.StoredProcedure;

                    cmd.Parameters.Add("@ProductionTypeID", SqlDbType.SmallInt);
                    cmd.Parameters["@ProductionTypeID"].Value = ProductionTypeID;
                    cmd.Parameters["@ProductionTypeID"].Direction = ParameterDirection.Input;
